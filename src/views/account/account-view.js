  ...
  return (
    <div className="account-container">
      ...
      <div className="account-body">
        ...
        {isShowingFriends && <FriendsListPortal friendsData={friendsData} setIsShowingFriends={setIsShowingFriends} />}
        {isShowingRequests && <RequestsListPortal currentUser={currentUser} setIsShowingRequests={setIsShowingRequests} />}
        {isShowingBlocked && <BlockedListPortal blockedUsers={blockedUsers} setIsShowingBlocked={setIsShowingBlocked} />}
        {isShowingPictures && <PicturesListPortal currentUser={currentUser} setIsShowingPictures={setIsShowingPictures} />}
        ...
        <SearchBar currentUser={currentUser} friendsData={friendsData} />
